...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	МассивПечатиНовый = Новый Массив;
	Для каждого ДанныеМассиваОбъектов из МассивОбъектов Цикл
		МассивПечатиНовый.Добавить(ДанныеМассиваОбъектов.ПриходныйОрдер);
	КонецЦикла;
	
	МассивОбъектов = МассивПечатиНовый;
