...
Процедура ПриСохраненииДанныхВНастройкахНаСервере(Настройки)
	...
	ХранилищаНастроек.ДанныеФорм.ДобавитьДополнительныеДанныеВНастройку(Объект, Настройки, Документы.ПриходныйОрдерНаКруглыйЛесоматериал.СтруктураДополнительныхДанныхФормы());
...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	ХранилищаНастроек.ДанныеФорм.ЗаполнитьОбъектДополнительнымиДанными(Объект, Настройки, Документы.ПриходныйОрдерНаКруглыйЛесоматериал.СтруктураДополнительныхДанныхФормы());
